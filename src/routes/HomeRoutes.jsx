...
import OpenReservationList from "@portal/openreservations/list/OpenReservationList.jsx";
...
export const HomeRouteNames = {
    ...
    OPEN_RESERVATION_LIST: `/online/openreservation/list/:id`,
};
...
const HomeRoutes = [
    ...
    {
        path: HomeRouteNames.OPEN_RESERVATION_LIST,
        element: <OpenReservationList />,
        title: 'openReservations',
        header: true
    }
];
