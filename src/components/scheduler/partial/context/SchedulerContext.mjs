...
const u = e.createContext({ start: /* @__PURE__ */ new Date(), end: /* @__PURE__ */ new Date(), zonedStart: i.fromLocalDate(/* @__PURE__ */ new Date()), zonedEnd: i.fromLocalDate(/* @__PURE__ */ new Date()) }), Z = () => e.useContext(u);
